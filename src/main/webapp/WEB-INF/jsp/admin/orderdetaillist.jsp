...
<body>
   ...
   <button id="addcatebtn">OrderDetail List</button>
         ...
         <thead>
          <tr>
			...
			<tr>
				...
				<td><span><a href="deleteorderdetail/${orderdetail.id}" id="ebbtn" onclick="return confirm('Are you sure Delete?')">Delete</a></span></td>

...
<body>
	...
	<form:form method="Post" action="save" modelAttribute="book" enctype="multipart/form-data">
	
            <h3 class="catetext">Add New Book</h3><br>
            <h4 class="catanamespan">Book Name:</h4>
            <form:input type="text"  path="name" placeholder="Write Book Name"  required="true" class="catenameadd"/><br><br>
            ...
            <form:input type="text" path="price" placeholder="Write Book Price" required="true" class="catenameadd"/><br><br>
